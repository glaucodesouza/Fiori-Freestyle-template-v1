		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Freestyle Template V1",
									"targetURL": "#freestyletemplatev1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"freestyletemplatev1-display": {
								"semanticObject": "freestyletemplatev1",
								"action": "display",
								"description": "Freestyle Template V1",
								"title": "Freestyle Template V1",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=freestyletemplatev1",
									"url": sap.ui.require.toUrl("freestyletemplatev1")
								}
							}
						}
					}
